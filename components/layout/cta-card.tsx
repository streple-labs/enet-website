...
export default function CtaCard() {
  return (
    <section className="relative flex items-center justify-center w-full">
      <div className="mw px-8 lg:px-20 py-8 md:py-24 flex items-center justify-center w-full">
        <div className="flex flex-col items-center w-full rounded-[19px] bg-[url('/cta-background.png')] bg-no-repeat bg-center p-4 sm:p-8 md:p-10 lg:p-[61px]">
          <div className="mb-4 md:mb-10 py-1 px-4 md:py-[11px] md:px-11 w-auto flex items-center gap-2.5 md:gap-[15px] rounded-[20px] backdrop-blur-2xl bg-[#FFFFFF24]">
            <span>
              <svg
                viewBox="0 0 19 24"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="w-2 h-2.5 md:w-5 md:h-6"
              >
                <path
            ...
            <p className="font-bold text-[6px]/2.5 sm:text-xs/4 md:text-base/[23px] text-[#00C853]">
              Enet Secured
            </p>
          </div>
          ...
          <div className="flex items-center justify-center gap-2.5 md:gap-6 lg:gap-[30px]">
            <Link href={"#"}>
              <button
                ...
                className="rounded-sm md:rounded-lg p-3 md:px-18 md:py-4 font-bold text-[9px]/3 md:text-lg/6 bg-[#004C99]"
              >
                Get Started
              </button>
            </Link>
            <Link href={"#"}>
              <button
                ...
                className="border border-[#F5F5F5] text-[#F5F5F5] rounded-sm md:rounded-lg p-3 md:px-18 md:py-4 font-bold text-[9px]/3 md:text-lg/6"
              >
                Book Audit
              </button>
            </Link>
