...
export default function page() {
  return (
    <main className="flex flex-col">
      <section className="homepage-hero-bg relative flex items-center justify-center w-full h-screen 2xl:h-auto 2xl:py-40">
        <div className="flex w-full justify-between mw px-20">
          <div className="flex flex-col gap-[30px] w-fit">
            <h1
              className={`${montserrat.className} font-bold text-[70px]/[90px] max-w-[690px] tracking-[0%] text-white`}
            >
              Innovate Securely. Scale Fearlessly.
            </h1>

            <p className="font-normal text-[18px] leading-[30px] tracking-[0%] text-[#EEEDFFCC] max-w-[653px]">
            ...
            <div className="flex gap-[44px] mt-5">
              <Link
                href={"#"}
      ...
      <section className="flex flex-row gap-12 px-20 py-28 why-enet-bg">
        <div className="relative">
          <span
            className={`${montserrat.className} font-bold text-[50px] leading-[60px] tracking-[0%] capitalize text-white`}
          >
            Why Choose Enet
            <br />
            Technologies?
          ...
          <p className="absolute bottom-0 font-normal text-[16px] leading-[26px] tracking-[0%] text-[#EEEDFFCC]">
            At Enet Technologies, we blend cybersecurity expertise,
            <br />
            scalable cloud solutions, and compliance strategies to help
            <br />
        ...
        <div className="flex flex-col gap-8">
          <div className="flex flex-col gap-[15px] border-b border-b-[#30393E]">
            <span
              className={`${montserrat.className} font-bold text-[24px] leading-[27px] tracking-[0%] text-[#004C99]`}
            >
              Trusted Expertise
            </span>
            <p className="pb-6">
              ...
              <br />
              we deliver proven strategies that keep
              <br />
          ...
          <div className="flex flex-col gap-[15px] border-b border-b-[#30393E]">
            ...
            <p className="pb-6">
              We leverage modern technologies and
              <br />
              agile approaches to provide future-ready
              <br />
          ...
          <div className="flex flex-col gap-[15px]">
            ...
            <p className="pb-6">
              From cybersecurity to compliance and
              <br />
              cloud protection, we safeguard your
              <br />
        ...
        <div className="flex flex-row w-full p-20 gap-28">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-2">
              <h6
                className={`${titillium_web.className} font-semibold text-[21px] leading-[24px] tracking-[0%] text-[#00C853]`}
              >
                CYBERSECURITY
              </h6>

              <span
                className={`${montserrat.className} font-semibold text-[50px] leading-[70px] tracking-[0%] capitalize text-white`}
              >
            ...
            <div className="grid grid-cols-2 gap-10">
              {cybersecurityCards.map((card) => (
                <div
                  key={card.alt}
                  className="colour-card w-[302px] h-[294px] rounded-2xl p-8 gap-2"
                >
                  <Image
                    loading="lazy"
                    src={card.icon}
                  ...
                  <div className="flex flex-col gap-4">
                    <span
                      className={`${montserrat.className} font-semibold text-[24px] leading-[32px] tracking-[0%] text-white`}
                    >
                      {card.title}
                    </span>
      ...
      <section className="testimonials-bg px-18 py-20">
        <div className="flex flex-col gap-2 items-center">
          ...
          <span
            className={`${montserrat.className} font-bold text-[54px] leading-[70px] tracking-[0%] text-white`}
          >
        ...
        <div className="flex flex-row w-full justify-center gap-[48px] mt-16">
          {Array.from({ length: 3 }).map((_, index) => (
            <div
              key={index}
              className="bg-[#AAAAAA0F] backdrop-blur-[50px] w-[400px] h-[329px] rounded-2xl flex flex-col p-8 gap-6"
            >
              <p className="font-normal text-[16px] leading-[23px] tracking-[0%] text-white">
                ...
                audit-ready in just weeks. Their team was
                <br />
        ...
        <div className="cta-bg flex flex-col py-14 items-center gap-10">
          <div className="flex flex-row gap-3 rounded-[20px] bg-[#FFFFFF24] backdrop-blur-[40px] items-center px-14 py-3">
            <Image
              ...
              height={24}
            />
            <span className="font-bold text-[16px] leading-[23px] tracking-[0%] text-[#00C853]">
              Enet Secured
            </span>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-normal text-[16px] leading-[26px] tracking-[0%] text-center capitalize text-[#EEEDFFCC]">
              ...
              your infrastructure, and stay <br />
          ...
          <div className="flex flex-row gap-[30px]">
            <Link
              href={"#"}
              className="bg-[#004C99] py-4 px-20 rounded-[8px] font-bold text-[16px] leading-[22px] tracking-[0%] text-white"
            >
              Get Started
            </Link>
            ...
            <Link
              href={"#"}
              className="border border-[#F5F5F5] py-4 px-20 rounded-[8px] font-bold text-[16px] leading-[22px] tracking-[0%] text-white"
            >
              Book Audit
            </Link>
          </div>
