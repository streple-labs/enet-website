        ...
        <div className="flex flex-row w-full justify-between mt-10">
          <div className="flex flex-col gap-[30px] mt-10 ml-26">
            <h1 className={`${montserrat.className} font-bold text-[70px] leading-[90px] tracking-[0%] text-white`}>
              Innovate Securely.<br />
              Scale Fearlessly.
            </h1>

            <p className="font-normal text-[18px] leading-[30px] tracking-[0%] text-[#EEEDFFCC]">
              Enet Technologies empowers businesses to stay secure, scale faster, and<br />
              comply effortlessly with next-gen cybersecurity, cloud solutions, and<br />
              DevSecOps.
            </p>

            <div className="flex flex-row gap-[44px] mt-5">
              <Link href={"#"} className="rounded-[8px] px-18 py-4 font-bold text-[18px] leading-[24px] tracking-[0%] text-white bg-gradient-to-r from-[#004C99] to-[#00C85380]">
                Get Started
              </Link>
              <Link href={"#"} className="rounded-[8px] px-18 py-4 font-bold text-[18px] leading-[24px] tracking-[0%] text-[#00C853] border border-[#00C853]">
                Book Audit
              </Link>
            </div>
          </div>
      ...
      <section className="bg-[#030E14] py-[59px]">
        <div className="flex flex-col gap-[18px]">
          ...
          <p className="font-normal text-[16px] leading-[26px] tracking-[0%] text-center capitalize text-[#EEEDFFCC]">
            We deliver next-gen cybersecurity, cloud solutions,
            DevSecOps, and compliance services — designed
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mx-auto px-24 mt-12">
          {cards.map((card) => (
            <div key={card.alt} className="rounded-[15px] bg-[#030C11] hover:bg-[url('/card-background.png')] bg-cover bg-center bg-no-repeat w-full h-full transition-all duration-500">
              <div className="flex flex-col py-[51px] ml-[40px] gap-[65px]">
                ...
                <div className="flex flex-col gap-[15px]">
                  <h4 className={`${montserrat.className} font-bold text-[24px] leading-[24px] tracking-[0%] text-white`}>
                    {card.title}
                  </h4>
        ...
        <Link href={"#"} className="flex flex-col mx-auto mt-12 px-28 py-4 bg-[#004C99] rounded-[8px] w-max font-bold text-[18px] leading-[24px] tracking-[0%] items-center text-white">
          View More
        </Link>
      </section>
